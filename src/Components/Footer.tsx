...
*/}
      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-4 rounded-lg bg-gray-600 p-6 shadow-lg sm:flex-row sm:justify-between">
            ...
            <a
              className="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-gray-600 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
              href="#"
            >
